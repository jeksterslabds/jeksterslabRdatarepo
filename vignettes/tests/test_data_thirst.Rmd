...
```{r fitted_model_implied_covariance, echo = FALSE}
knitr::kable(
  x = muhatthetahat,
...
```{r fitted_model_implied_mean, echo = FALSE}
knitr::kable(
  x = Sigmahatthetahat,
